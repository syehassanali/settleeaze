...
const FinalCTA = () => (
  <section className="py-24 text-center" style={{ background: 'linear-gradient(135deg, #1976d2, #9c27b0)' }}>
    <div className="container mx-auto px-4">
      ...
      <Link to="/booking" className="inline-block px-10 py-4 bg-white text-primary font-bold rounded-full hover:bg-gray-100 transition-colors shadow-lg">Get Started Now</Link>
